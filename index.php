    ...
    <div class="container mt-4" style="margin-bottom: 100px;">
        <div class="text-center mb-3">
            <div class="text-center">
                <h1 class="text-light"><b>CHK KIWIFY</b></h1>
                <div class="text-center">
                    <center><h class="text-light"><b><p>ᴄᴏᴅᴀᴅᴏ ᴘᴏʀ @NocyamIsLonely🇷🇺</p></b></h></center>
...
var audioLive = new Audio('Live.mp3');
                        ...
                        var ajaxCall = $.ajax({
                            ...
                            success: function(resultado) {
                                if (resultado.match("Aprovada")) {
                                    ...
                                    removelinha();
                                    rp++;
                                    reprovadas(resultado + "Email/Senha Incorreto");
                                    $('#status_ccs').html('DIE');
                                }
	...
	<center><h class="text-light"><b>Copyright NocyamSolo 2024</b></h></center>
  </body>
</html>